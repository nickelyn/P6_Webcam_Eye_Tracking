...
class Calibration(object):
    """
    Calibrates the pupil detection algorithm by finding the best binarisation threshold value for the person and the webcam.
    """
    ...
    def find_best_threshold(eye_frame):
        """
        Calculates the optimal threshold to binarise the frame for the given eye.

        Args:
            eye_frame (numpy.ndarray): Frame of the eye to be analysed.
