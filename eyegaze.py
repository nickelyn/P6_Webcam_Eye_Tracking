...
def getFace():
    ...
    while True:
        ...
        for face in faces:
            ...
            re_vertical_line_len = hypot((re_center_top_point[0] - re_center_bottom_point[0]),
                                         (re_center_top_point[1] - re_center_bottom_point[1]))

            le_vertical_line_len = hypot((le_center_top_point[0] - le_center_bottom_point[0]),
                                         (le_center_top_point[1] - le_center_bottom_point[1]))

            #Find the length of the horizontal line for right and left eye
            re_horizontal_line_len = hypot((re_left_point[0] - re_right_point[0]),
                                           (re_left_point[1] - re_right_point[1]))

            le_horizontal_line_len = hypot((le_left_point[0] - le_right_point[0]),
